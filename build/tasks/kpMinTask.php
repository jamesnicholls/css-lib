  ...
  public function main()
  {
    ...
    foreach( $this->filesets as $fs ) 
    {
      try 
      {
        ...
        $fullPath = preg_replace('/\s/', '\ ', $fullPath);
        ...
        foreach( $files as $file ) 
        {
          ...
          $cmd = str_replace( '{target}', preg_replace('/\s/', '\ ', realpath( $target )), $cmd );
          $cmd = str_replace( '{yuipath}', preg_replace('/\s/', '\ ', realpath( $this->yuiPath )), $cmd );
